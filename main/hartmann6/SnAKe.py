...
def christofides(distance_matrix, start = 0):
    ...
    # Step 3: Find a Minimum Weight Perfect Matching (MWPM) for odd-degree nodes
    def find_min_weight_matching(odd_nodes):
        ...
        # Greedily select pairs to form the matching
        matching = []
        used = set()
        for pair in pairs:
    ...
    # Step 4: Combine MST and MWPM to form a multigraph
    ...
    # Calculate the total distance of the Hamiltonian Path
    total_distance = 0
