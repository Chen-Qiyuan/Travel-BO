...
if __name__ == "__main__":
    ...
    import pandas as pd
    pd.DataFrame(cum_regret_table).T.to_excel("TUCB2_reg.xlsx", index=False, engine='openpyxl')
    pd.DataFrame(cum_travel_table).T.to_excel("TUCB2_travel.xlsx", index=False, engine='openpyxl')