...
algorithms = [
    "TUCB", "TTS", "UCB", "TS", "MINI", "TuRBO", "RS", "LHS", "GS", "SnAKe"
    ]
...
def plot_from_files():
    ...
    for file in reordered_files_reg:
        df = pd.read_csv(file)[:200] * 17.0670
