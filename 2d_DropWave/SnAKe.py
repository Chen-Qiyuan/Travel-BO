...
class agent():
    ...
    def plan_next_batch(self):         
        ...
        candidates_before_delete = torch.tensor([])
...
if __name__ == "__main__":
    ...
    pd.DataFrame(cum_regret_table).T.to_csv("SnAKe_reg.csv", index=False)
    pd.DataFrame(cum_travel_table).T.to_csv("SnAKe_travel.csv", index=False)