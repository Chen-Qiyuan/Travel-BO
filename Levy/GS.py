...
from botorch.test_functions import Hartmann, Cosine8, Levy, Ackley, Branin, DropWave, EggHolder, Powell, Griewank
...
if __name__ == "__main__":
    ...
    import pandas as pd
    pd.DataFrame(cum_regret_table).T.to_excel("GS_reg.xlsx", index=False, engine='openpyxl')
